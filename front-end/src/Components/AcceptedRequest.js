            ...
            <div className='container'>
                ...
                <div className="row requestBody">
                    ...
                    <div className="col-4 uploadPaper" style={{marginTop:  "10px"}}>
                        ...
                        <form action="http://localhost:5000//UploadResult" method='post' enctype="multipart/form-data" style={{marginTop: "7px"}}>
                            <input type="file" name="Result" className="form-control" required />
                            <button type="submit" className="submit-btn" disabled>Upload Result</button>
                        </form>
                    </div>
                </div>
            </div>
